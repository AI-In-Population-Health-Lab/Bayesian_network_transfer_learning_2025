 ...
 */
public class BTLSM_V8_max1 extends SearchAlgorithm implements TechnicalInformationHandler {
...
//	private final boolean m_bInitAsNaiveBayes = false; 
	 ...
	 * default constructor
	 */
	public BTLSM_V8_max1() {
	} // c'tor

	/**
	 * default constructor
	 */
	public BTLSM_V8_max1(int predictors, int max_parents, int max_children) {
	 ...
	 * default constructor
	 */
	public BTLSM_V8_max1(int predictors, int max_parents, int max_children, int pess) {
		setExpectedParentsOfTarget(predictors);
		setMaxNrOfParents(max_parents);
		setMaxNrOfChildren(max_children);
	 ...
	 */
	//Ye added
	public BTLSM_V8_max1(int maxParent, String configFile, String scoreMethod, String adjustMethod, 
	 ...
	 */
	//Ye added
	public BTLSM_V8_max1(String configFile, String scoreMethod, String adjustMethod, 
			String startNetwork,  double trueKL1, HashMap<String,Double> trueBFWeightTable1,
			double avgKL1, HashMap<String,Double> avgBFWeightTable1) throws Exception {
...
//	    	System.out.println(source_clean_BayesNet);
	...
	//    	System.out.println("K:" + k);	
		 ...
		 */
		//Ye added
			public BTLSM_V8_max1(int predictors, int max_parents, int max_children, String sourceModelFile) throws Exception {
				setExpectedParentsOfTarget(predictors); 
				setMaxNrOfParents(max_parents);
				setMaxNrOfChildren(max_children);
				source_BayesNet = new BIFReader();
		 ...
		 */
		//Ye added
		public BTLSM_V8_max1(int predictors, int max_parents, int max_children, String sourceModelFile, int sourceSize) throws Exception {
			setExpectedParentsOfTarget(predictors); 
			setMaxNrOfParents(max_parents);
			setMaxNrOfChildren(max_children);
			source_BayesNet = new BIFReader();
