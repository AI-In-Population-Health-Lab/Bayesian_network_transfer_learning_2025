 ...
 */
public class BTLSM_V8 extends SearchAlgorithm implements TechnicalInformationHandler {
...
//	private final boolean m_bInitAsNaiveBayes = false; 
	 ...
	 * default constructor
	 */
	public BTLSM_V8(int predictors, int max_parents, int max_children) {
	 ...
	 * default constructor
	 */
	public BTLSM_V8(int predictors, int max_parents, int max_children, int pess) {
		setExpectedParentsOfTarget(predictors);
		setMaxNrOfParents(max_parents);
		setMaxNrOfChildren(max_children);
	 ...
	 */
	//Ye added
	public BTLSM_V8(String configFile, String scoreMethod, String adjustMethod, 
...
//	 	net.readFile("00experiment/intermediate/source_clean_inject.xdsl");
		System.out.println("source inject model:"+sourceModelLoc+sourceCleanInjectModelXDSL);
    	...
    	//int max_parents = m_MaxNrOfParents;
...
//	    	System.out.println(source_clean_BayesNet);
	...
	//    	System.out.println("K:" + k);	
		 ...
		 */
		//Ye added
			public BTLSM_V8(int predictors, int max_parents, int max_children, String sourceModelFile) throws Exception {
				setExpectedParentsOfTarget(predictors); 
				setMaxNrOfParents(max_parents);
				setMaxNrOfChildren(max_children);
				source_BayesNet = new BIFReader();
		 ...
		 */
		//Ye added
		public BTLSM_V8(int predictors, int max_parents, int max_children, String sourceModelFile, int sourceSize) throws Exception {
			setExpectedParentsOfTarget(predictors); 
			setMaxNrOfParents(max_parents);
			setMaxNrOfChildren(max_children);
			source_BayesNet = new BIFReader();
