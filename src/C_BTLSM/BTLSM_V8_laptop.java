 ...
 */
public class BTLSM_V8_laptop extends SearchAlgorithm implements TechnicalInformationHandler {
...
//	private final boolean m_bInitAsNaiveBayes = false; 
	 ...
	 * default constructor
	 */
	public BTLSM_V8_laptop() {
	} // c'tor

	/**
	 * default constructor
	 */
	public BTLSM_V8_laptop(int predictors, int max_parents, int max_children) {
	 ...
	 * default constructor
	 */
	public BTLSM_V8_laptop(int predictors, int max_parents, int max_children, int pess) {
		setExpectedParentsOfTarget(predictors);
		setMaxNrOfParents(max_parents);
		setMaxNrOfChildren(max_children);
	 ...
	 */
	//Ye added
	public BTLSM_V8_laptop(String configFile, String scoreMethod, String adjustMethod, 
...
//	    	System.out.println(source_clean_BayesNet);
	...
	//    	System.out.println("K:" + k);	
		 ...
		 */
		//Ye added
			public BTLSM_V8_laptop(int predictors, int max_parents, int max_children, String sourceModelFile) throws Exception {
				setExpectedParentsOfTarget(predictors); 
				setMaxNrOfParents(max_parents);
				setMaxNrOfChildren(max_children);
				source_BayesNet = new BIFReader();
		 ...
		 */
		//Ye added
		public BTLSM_V8_laptop(int predictors, int max_parents, int max_children, String sourceModelFile, int sourceSize) throws Exception {
			setExpectedParentsOfTarget(predictors); 
			setMaxNrOfParents(max_parents);
			setMaxNrOfChildren(max_children);
			source_BayesNet = new BIFReader();
