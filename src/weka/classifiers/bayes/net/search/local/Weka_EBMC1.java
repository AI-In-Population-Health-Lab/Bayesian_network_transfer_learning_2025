...
/*****Able to run EBMC1, obtain intermediate models ******/
 ...
 */
public class Weka_EBMC1 extends SearchAlgorithm implements TechnicalInformationHandler {
	 ...
	 * default constructor
	 */
	public Weka_EBMC1(int predictors, int max_parents, int max_children) {
	 ...
	 * default constructor
	 */
	public Weka_EBMC1(int predictors, int max_parents, int max_children, int pess) {
		setExpectedParentsOfTarget(predictors);
		setMaxNrOfParents(max_parents);
		setMaxNrOfChildren(max_children);
...
//		}
		...
		//EBMC1 Algorithm
		 int numberGraph=0;
		  ...
		  while (hopeRemains && (numberOfChildren < maxChildren)) {
	       ...
	       //     PrintWriter printout = new PrintWriter(new File("model_b" + numberGraph + ".xml"));
	...
	/****Ye method ****************/
	protected void copySourceModel(String[][] sourceParents){
