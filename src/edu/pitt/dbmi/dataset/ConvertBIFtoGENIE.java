...
public class ConvertBIFtoGENIE {
    ...
    public void runner(String inputFile, String outputDirectory, String hashFile, String format){
        ...
        // CREATE OUTPUT FILE
        System.out.println("\n------------\n Creating file... ");
        String name[] = inputFile.split("\\.xml");
        String outputName = name[0] + "."+format;
        if (inputFile.contains(".bif")) {
            String name2[] = inputFile.split(".bif");
            outputName = name2[0] + "."+format;
        }
    ...
    public void runner(String inputFileLoc, String inputFileName, String outputDirectory, String hashFile, String format){
        ...
        // CREATE OUTPUT FILE
        System.out.println("\n------------\n Creating file... ");
        String outputName = inputFileName.replace(".bif", "") + "."+format;
        System.out.println(outputDirectory+outputName);
        FileManager.write(outputDirectory+outputName, out);
        System.out.println("\n------------\nNew File created");
    }
